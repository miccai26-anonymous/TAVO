...
TEMPLATE_YAML = PROJECT_ROOT / "configs_TCGA_GBM_cma/template.yaml"

SCORE_ROOT = PROJECT_ROOT / "data/splits_TCGA_GBM_mix_scores_multi"
SPLIT_ROOT = PROJECT_ROOT / "data/splits_TCGA_GBM_stageA2"
OUT_ROOT   = PROJECT_ROOT / "outputs_TCGA_GBM_stageA2"
...
WARMUP_CKPT = (
    "/path/to/workspace/"
    "ANON_USER/EfficientVit/outputs_TCGA_GBM/"
    "baseline3_brats21_source_plus_target/epoch_005.pt"
)
...
def stageA2_cma(
    ...
    # ===============================
    # 1️⃣ FULL SOURCE (no split_txt filtering)
    # ===============================
    full_source_dataset = BraTSSliceDataset(
        root_dir=source_dom["path"],
        split="train",
        img_size=img_size,
        split_txt_dir=source_dom.get("split_txt"),          # ⭐ full source set
