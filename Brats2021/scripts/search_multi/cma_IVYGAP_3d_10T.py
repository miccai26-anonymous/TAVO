...
TEMPLATE_YAML = PROJECT_ROOT / "configs_IVYGAP_cma/template.yaml"

SCORE_ROOT = PROJECT_ROOT / "data/splits_IVYGAP_mix_scores_multi"
SPLIT_ROOT = PROJECT_ROOT / "data/splits_IVYGAP_stageA2"
OUT_ROOT   = PROJECT_ROOT / "outputs_IVYGAP_stageA2"
...
WARMUP_CKPT = (
    "/path/to/workspace/"
    "ANON_USER/EfficientVit/outputs_IVYGAP/"
