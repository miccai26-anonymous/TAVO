...
# ============================================================
# CRAIG Full Ranking (Official submodlib version)
# ============================================================
...
def main():
    ...
    out_dir  = f"data/splits_C4_craig_repeat{r:02d}"
    ...
    np.save(
        os.path.join(out_dir, "craig_full_rank_score_dict.npy"),
        score_dict,
        allow_pickle=True
    )

    print("💾 Saved craig_full_rank_score_dict.npy")
    ...
    print("\n🎉 Official CRAIG full ranking + subsets complete!")
