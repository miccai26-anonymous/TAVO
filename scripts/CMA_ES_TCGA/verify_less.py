...
def verify_tcga_less(base_dir, T=50):
    """
    Verify LESS score dict for TCGA (no repeat).
    """
    base = os.path.join(base_dir, "splits_TCGA_less")
    print(f"\n==============================")
    print(f"🔍 Verifying LESS for TCGA")
    print(f"Path: {base}")
    print(f"==============================")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="./data",
        help="Base directory containing splits_TCGA_less"
    )
    parser.add_argument(
        "--T",
        type=int,
    ...
    verify_tcga_less(args.base_dir, T=args.T)
