...
# ============================================================
# Diversity Ranking (Sum of Pairwise Distance Greedy)
# ============================================================
def diversity_full_ranking(X, max_rank=750, normalize=True, eps=1e-12):
...
def main():
    ...
    # 🔥 TCGA feature embedding 路径
    base_dir = "data/splits_TCGA_rds"
    out_dir  = "data/splits_TCGA_diversity"
    ...
    # ============================================================
    selected_order = diversity_full_ranking(
        src_vecs,
    ...
    np.save(
        os.path.join(out_dir, "diversity_score_dict.npy"),
        score_dict,
        allow_pickle=True
    )

    print("💾 Saved diversity_score_dict.npy")
    ...
    print("\n🎉 TCGA Diversity full ranking + subsets complete!")
