...
TEMPLATE_YAML = PROJECT_ROOT / "configs_UPENN_cma/template.yaml"

SCORE_ROOT = PROJECT_ROOT / "data/splits_UPENN_mix_scores_multi"
SPLIT_ROOT = PROJECT_ROOT / "data/splits_UPENN_stageA2"
OUT_ROOT   = PROJECT_ROOT / "outputs_UPENN_stageA2"
...
WARMUP_CKPT = (
    "/path/to/workspace/"
    "ANON_USER/EfficientVit/outputs_UPENN/"
