...
TEMPLATE_YAML = PROJECT_ROOT / "configs_C5_cma/template.yaml"

SCORE_ROOT = PROJECT_ROOT / "data/splits_C5_mix_scores_multi"
SPLIT_ROOT = PROJECT_ROOT / "data/splits_C5_stageA2"
OUT_ROOT   = PROJECT_ROOT / "outputs_C5_stageA2"
...
WARMUP_CKPT = (
    "/path/to/workspace/"
    "ANON_USER/EfficientVit/outputs_C5/"
